# @devtea2026/veritatis-perferendis-pariatur-occaecati

![CI](https://github.com/devtea2026/veritatis-perferendis-pariatur-occaecati/workflows/CI/badge.svg)
[![NPM version](https://img.shields.io/npm/v/@devtea2026/veritatis-perferendis-pariatur-occaecati.svg?style=flat)](https://www.npmjs.com/package/@devtea2026/veritatis-perferendis-pariatur-occaecati)
...
`@devtea2026/veritatis-perferendis-pariatur-occaecati` supports Fastify@3.
`@devtea2026/veritatis-perferendis-pariatur-occaecati` [v1.x](https://github.com/devtea2026/veritatis-perferendis-pariatur-occaecati/tree/1.x)
supports both Fastify@2.

## Install
```
npm i @devtea2026/veritatis-perferendis-pariatur-occaecati
```
...
fastify.register(require('@devtea2026/veritatis-perferendis-pariatur-occaecati'), {
  secret: 'supersecret'
})
...
const fastify = require('fastify')()
const jwt = require('@devtea2026/veritatis-perferendis-pariatur-occaecati')
// secret as a string
...
Optionally you can define global default options that will be used by `@devtea2026/veritatis-perferendis-pariatur-occaecati` API if you do not override them.
...
```
### fastify.jwt.cookie
For your convenience, `request.jwtVerify()` will look for the token in the cookies property of the decorated request. You must specify `cookieName`. Refer to the [cookie example](https://github.com/devtea2026/veritatis-perferendis-pariatur-occaecati#example-using-cookie) to see sample usage and important caveats.
...
The following algorithms are currently supported by [fast-jwt](https://github.com/nearform/fast-jwt) that is internally used by `@devtea2026/veritatis-perferendis-pariatur-occaecati`.
...
```js
const Fastify = require('fastify')
const fjwt = require('@devtea2026/veritatis-perferendis-pariatur-occaecati')
...
```ts
import fastifyJwt, { FastifyJWTOptions } from '@devtea2026/veritatis-perferendis-pariatur-occaecati'
```
...
```ts
// fastify-jwt.d.ts
import "@devtea2026/veritatis-perferendis-pariatur-occaecati"

declare module "@devtea2026/veritatis-perferendis-pariatur-occaecati" {
